...
/* Telefono.
el programa, al al recibir como datos la clave de la zona geografica y el
 numero de segundo de una llamada telefonica, calcula el costo de la misma.

 CLA y TIE: variables de tipo entero.
 COS: vatriable de tipo real. */

 void main(void)
 {
     int CLA, TIE;
     float COS;
     printf("Ingresa la clave del tiempo: ");
     scanf("%d %d" , &CLA, &TIE);
     switch (CLA)
     {
